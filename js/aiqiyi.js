var rule = {
    ...
    timeout: 5000,
    class_name: '电视剧&电影&纪录片&动漫&综艺&音乐&网络电影',
    class_url: '2&1&3&4&6&5&16',
    limit: 20,
    play_parse: true,
    lazy: $js.toString(() => {
        try {
