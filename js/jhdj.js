...
const aggConfig = {
  ...
  platformList: [
     { name: '星芽短剧', id: '星芽' }, { name: '七猫短剧', id: '七猫' }, { name: '锦鲤短剧', id: '锦鲤' },
     { name: '甜圈短剧', id: '甜圈' }, { name: '西饭短剧', id: '西饭' },{ name: '软鸭短剧', id: '软鸭' }, 
     { name: '番茄短剧', id: '番茄' },{ name: '围观短剧', id: '围观' }
  ],
...
async function search(wd, quick, pg) {
  ...
  const platforms = [ '锦鲤', '番茄', '星芽', '西饭', '软鸭', '围观', '甜圈'];
    ...
    try {
      ...
      if (tid === '锦鲤') {
        ...
        data = (JSON.parse(res)?.data || []).map(i => ({
          ...
          vod_name: i.title,
          vod_pic: i.cover,
          vod_remarks: `甜圈短剧｜${i.sub_title || '聚合短剧'}`
        }));
      }
