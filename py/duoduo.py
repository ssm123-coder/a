...
# QQ群：807916734
"""
目标站: 多多影视 (dduotv01.top)
站点类型: Vue.js SPA + Protobuf API
功能: 首页推荐、分类、搜索、详情、播放
版本: V4.0 - 线路过滤+纯Python解码版
...
class Spider(Spider):
    def init(self, extend=""):
        try:
            ...
            pass
        self.extend = extend
        self.site_url = "https://dduotv01.top"
    ...
    def _api_get(self, path, params=None):
        ...
        try:
            ...
            print("[多多影视] API请求失败: {} -> {}".format(path, e))
        return None
    ...
    def _http_post_binary(self, url, data, headers=None):
        ...
        try:
            ...
            print("[多多影视] urllib POST 失败: {}".format(e))
        ...
        try:
            ...
            print("[多多影视] curl POST 失败: {}".format(e))
    ...
    def _decode_url(self, play_url, from_str):
        ...
        try:
            ...
            if resp_fields.get(1) == 1 and resp_fields.get(3):
                ...
                print("[多多影视] 解码失败: code={}, msg={}".format(resp_fields.get(1), msg))
        except Exception as e:
            print("[多多影视] 解码异常: {}".format(e))
        return None
    ...
    def detailContent(self, ids):
        ...
        for line in enabled_lines:
            display_parts.append("{}@@{}".format(line["show"], line["from_code"]))
    ...
    def playerContent(self, flag, id, vipFlags=None):
        ...
        # flag 格式: "显示名@@from_code" 或纯 from_code
        from_code = flag
        if "@@" in flag:
            parts = flag.split("@@")
            if len(parts) >= 2:
